...
export async function getTeacherLessons(teacherId: string, schoolId: string) {
  try {
    if (!schoolId) {
        console.error("SchoolId is required to get teacher lessons.");
        return [];
    }
...
export async function getLessonById(lessonId: number, schoolId: string) {
  try {
    if (!schoolId) {
        console.error("SchoolId is required to get lesson by ID.");
        return null;
    }
...
export async function getAttendanceHistory(lessonId: number, schoolId: string) {
  try {
    if (!schoolId) {
        console.error("SchoolId is required to get attendance history.");
        return [];
    }
